...
HardwareHelloAODV::HardwareHelloAODV(uint32_t ip, uint64_t helloDurationMS):HardwareAODV(ip){
    _hardwareHelloAODV(helloDurationMS);
}

HardwareHelloAODV::HardwareHelloAODV(const char* ip, uint64_t helloDurationMS):HardwareAODV(ip){
    _hardwareHelloAODV(helloDurationMS);
}

HardwareHelloAODV::~HardwareHelloAODV(){
    delete helloMonitor;
}
